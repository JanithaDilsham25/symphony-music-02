...
import tabfooter from "../assets/footer/tabedit.png";
...
function Footer() {
  return (
    <>
      {/* Mobile  */}
      {/* Tablet  */}
      <section className="hidden sm:inline lg:hidden w-full h-auto">
        <div
          className="w-full h-[450px] bg-no-repeat bg-contain bg-bottom"
          style={{
      ...
      {/* Desktop */}
      <section className="hidden lg:inline w-full h-auto">
        <div
            ...
            <div className="w-fit h-fit flex flex-col justify-center items-left gap-18">
              <div className="flex flex-col gap-5">
                ...
                <div className="text-[#99A1AF] text-[16px] flex flex-col gap-3">
                  <div className="flex flex-row items-center gap-4">
                    <div className="w-5 h-5 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${email})`,}}></div>
                    <div className="">info@harmonymusic.com</div>
                  </div>
                  <div className="flex flex-row items-center gap-4">
                    <div className="w-5 h-5 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${call})`,}}></div>
                    <div>+1 (555) 123-4567</div>
                  </div>
                  <div className="flex flex-row items-center gap-4">
                    <div className="w-5 h-5 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${location})`,}}></div>
                    <div className="">
              ...
              <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-row gap-5">
                  <div className="w-10 h-10 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${fb})`,}}></div>
                  <div className="w-10 h-10 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${insta})`,}}></div>
                  <div className="w-10 h-10 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${twitter})`,}}></div>
                  <div className="w-10 h-10 bg-cover bg-center bg-no-repeat" style={{backgroundImage: `url(${youtube})`,}}></div>
                </div>
              </div>
            </div>
