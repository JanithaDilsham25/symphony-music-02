...
function Card(props) {
  return (
    <div
      className="
        w-full h-[114px] md:h-[220px] xl:h-[220px]
  ...
  />
      ...
      <div className="flex flex-col items-start md:items-center text-left md:text-center gap-[12px] md:gap-[14px] xl:gap-[1px]">
        <h2 className="text-[1.25rem] md:text-[1.5rem] xl:text-[1.30rem] font-secondary font-semibold text-[#0A0A0A] leading-[17.94px] md:leading-[24px] xl:leading-[30px]">
          {props.topic}
        </h2>
        <p className="text-[1rem] md:text-[1.25rem] xl:text-[1rem] font-inter text-[#454545] leading-[24px] md:leading-8 xl:leading-7 ">
          {props.para}
        </p>
      </div>
    </div>
