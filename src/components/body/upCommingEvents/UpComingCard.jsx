              ...
              <div className="w-6/9 h-full">
                <div className="w-5/6 h-full ml-3 flex flex-col justify-center gap-2">
                  ...
                  <div className="flex flex-row gap-3 items-center">
                    <div className="w-6 h-6 bg-cover bg-no-repeat bg-center" style={{ backgroundImage: `url(${icon1})` }}></div>
                  ...
                  <div className="flex flex-row gap-3 items-center">
                    <div className="w-6 h-6 bg-contains bg-no-repeat bg-center" style={{ backgroundImage: `url(${icon2})` }}></div>
                    <div className="text-[16px] text-secondary">
