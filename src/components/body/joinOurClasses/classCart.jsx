...
export default function ClassCart({ image, grade, date, time, location }) {
  return (
    <div className="relative w-77.5 md:w-80 xl:w-7/12 flex flex-col items-center p-4 gap-4 rounded-[7.76px] bg-red-100 border border-black">
      ...
      <div className="w-full  p-2 rounded-md flex flex-col items-start gap-3">
        ...
        <div className="w-full gap-1.5 flex flex-col ">
          <div className="flex items-center gap-3">
            ...
            <span className="font-inter font-normal text-[14px] flex items-center">
              {date}
            </span>
          </div>
        ...
        <button
          className="
            ...
            w-full
            rounded-lg xl:border xl:border-black 
        ...
        >
          ...
          <span className=" hidden xl:inline font-inter font-medium text-[14px] text-black">
            View details
          </span>
        </button>
      </div>
